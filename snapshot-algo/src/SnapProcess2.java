...
class SnapShot2 {
	...
	SnapShot2(int id, int val, String[] inChannels) {
		value = val;
		channels = new HashMap<String, Integer>();
		for (String inChannel : inChannels)
			channels.put(inChannel, 0);
	}
...
public class SnapProcess2 extends UnicastRemoteObject implements ProcessInterface, Runnable {
	...
	public SnapProcess2(HashMap<String, Integer> servers) throws RemoteException {
		super();
	...
	public static void main(String[] args) {
		...
		try {
			...
			Thread t1 = new Thread(process, "trans");
			t1.run();
